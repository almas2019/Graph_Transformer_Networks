...
python main.py --dataset graph_het_subsampled_tcell_fib --model FastGTN --num_layers 2 --epoch 500 --lr 0.01 --channel_agg mean --num_channels 2 --save_metrics --runs 1
